...
fn deserialize_difficulty<'de, D: serde::Deserializer<'de>>(deserializer: D) -> Result<Option<f64>, D::Error> {
    ...
    match value {
        ...
        Value::Null => Ok(None),
        v => Err(serde::de::Error::custom(format!("invalid difficulty type: {}", v))),
    }
}
